...
export default {
  data() {
    return {
      heroContent: {
        heroImage: require(`@/assets/images/hero/dark.jpeg`),
        heroMobileImage: require(`@/assets/images/hero/dark.jpeg`),
        heroTitleName: "Mahmoud Al-Saidi",
        heroDesignation: "web designer",
        heroDescriptions: `I'm a UK based web designer focused on
        providing clean & user‑friendly experiences, I am passionate about
        providing excellent software that improves the lives of those
        around me.`,
